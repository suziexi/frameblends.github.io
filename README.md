...
### Blog Report 7 
#### Monday 
- Move the fully annotated text with current FBL tag from FrameNet into gallina, it can be accessed with the following commend: cd /mnt/rds/redhen/gallina/Singularity/frameblends/simple_label/framenet_simple_label. A README.md file has been added. 
