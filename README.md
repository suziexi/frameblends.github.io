...
### Blog Report 2 
#### Weekly Summary 
In this week, I begin to investigate the existing frame analysing systems, including Semafor, Open Sesame, and Sling, request and study the hand-annotation data（Full Text Annotation) from FrameNet. I also conduct a report for [comparing the existing frame analysing tools,including Semafor, Open Sesame, and Sling](#comparing-the existing-frame-analysing-tools-including-semafor-open-sesame-and-sling). On the theoretical level, I’m reflecting on the mechanism for detecting frame blends, and will discuss my questions and thoughts in the mentor meeting next week. 
...
#### Sunday 
comparing the existing frame analysing tools,including Semafor, Open Sesame, and Sling
